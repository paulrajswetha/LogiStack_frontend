...
import { osQuestions, topicsList, levelsList } from "./Osdata";
    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--text-primary)] font-sans">
      ...
      <div className="max-w-[1000px] mx-auto px-5 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight mb-1">Operating System Interview Questions</h1>
          <p className="text-[var(--text-secondary)] text-sm">
            {osQuestions.length} questions covering Basic, Intermediate &amp; Advanced topics
          </p>
        </div>
        ...
        {mode === "study" ? (
          <>
            <div className="text-xs text-[var(--text-secondary)] mb-3">
              Showing {filtered.length} of {osQuestions.length} questions
            </div>
          ...
          <QuizMode questions={filtered.length > 0 ? filtered : osQuestions} />
        )}
      </div>
    </div>
  );
